...
describe('[Activity Hub]', () => {
	...
	before(async () => {
		...
		// Send a message that mentions testUser
	...
	describe('[/activity-hub.starred-messages]', () => {
		...
		it('total should match count when no pagination applied', async () => {
	...
	describe('[/activity-hub.activities]', () => {
		...
		it('should respect pagination: offset + count', async () => {
